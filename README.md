...
数据源：**高德 MCP** + **美团攻略 WebFetch** + **[小红书 Skill](https://github.com/autoclaw-cc/xiaohongshu-skills)**。大众点评因反爬过严，**已废弃不用**。
...
AI → 问硬约束 → 三阶段规划 → validate → 渲染 HTML → 部署 → 给你 URL
```
...
| [xiaohongshu-skills](https://github.com/autoclaw-cc/xiaohongshu-skills) | 推荐 | 排队 / 避雷；未装则降级 WebFetch |
...
| 文档 | 内容 |
|------|------|
| [SKILL.md](SKILL.md) | AI 主流程（Step 0–7） |
...
| [xhs-research.md](references/xhs-research.md) | 小红书调研方法 |
